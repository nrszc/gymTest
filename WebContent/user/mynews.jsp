...
<li><a href="../userServlet?method=find_mynews" class="selected">我的信息</a></li>
...
%>
		<div class="panel-body" style="margin-top:5%;">
					<form action="../userServlet?method=update_mynews" method="post" class="form form-horizontal responsive">
						<div class="row cl">
							<label class="form-label col-xs-3">会员名：</label>
							<div class="formControls col-xs-8">
								<input type="text" onBlur="return checkName()" value=<%=user.getUsername() %>  style="width:600px;" class="input-text" placeholder="会员名" name="username" id="txtUser">
								&#12288;&#12288;
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8">
								<input style="width:600px;" type="password" class="input-text" autocomplete="off" placeholder="密码" name="password" id = "Pwd">
								&#12288;&#12288;
								<span id = "tips_Pwd" >*请输入您的原密码</span>
							</div>
						</div>
						<div class="row cl">
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8">
								<input style="width:600px;" value=<%=user.getPhone() %> onBlur="return checkPhone()" type="text" class="input-text" autocomplete="off" placeholder="手机" name="telephone" id="phone">
								&#12288;&#12288;
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8">
								<input style="width:600px;" value=<%=user.getBirthdate() %> onBlur="return checktxtDate()" type="date" class="input-text" placeholder="出生日期" autocomplete="off" id = "txtDate" name="datetimepicker">
								&#12288;&#12288;
							<span id = "tips_birthdate" ></span>	
							</div>
						</div>
						<div class="row cl">
							<label class="form-label col-xs-3">邮箱：</label>
							<div class="formControls col-xs-8">
								<input style="width:600px;" value=<%=user.getEmail() %> type="text" class="input-text" onBlur="return checkEmail()" placeholder="电子邮箱" name="email" id = "txtMail" autocomplete="off">
								&#12288;&#12288;
									...
									<div class="col-xs-6" style="width:14%;">
										<span class="select-box">
											<select class="select" size="1" name="districtAndCounty" id="districtAndCounty">
												<option value=<%=user.getCounty() %>><%=user.getCounty() %></option>
											</select>
										</span>
									</div>
									<div class="col-xs-6" style="width:60%;">
									<div class="formControls col-xs-8">
								         <input type="text" value=<%=user.getAddress() %> style="width:206px;" class="input-text" onBlur="return checkAddress()" placeholder="详细地址" name="address" id = "address" >
								         &#12288;&#12288;
