...
<li><a href="add_gym.jsp" class="selected">场地录入</a></li>
<li><a href="../adminServlet?method=find_gym">场地查询</a></li>
<li><a href="../Servlet?method=logout">注销</a></li>
		...
		<div class="panel-body" style="margin-top:5%;">
					<form action="../adminServlet?method=add_gym" enctype="multipart/form-data" method="post" class="form form-horizontal responsive">
					...
					<div class="row cl">
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8">
								<input style="width:600px;" type="text" class="input-text" placeholder="场地名称" name="gymname">
							</div>
						</div>
						<div class="row cl">
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8">
								<input style="width:600px;" type="text" class="input-text" autocomplete="off" placeholder="价格" name="price" >
							</div>
						</div>
						<div class="row cl">
							<label class="form-label col-xs-3">手机：</label>
							<div class="formControls col-xs-8">
								<input style="width:600px;" type="text" class="input-text" autocomplete="off" placeholder="手机" name="telephone" id="telephone">
							</div>
						</div>
						<div class="row clearfix">
							...
							<div class="formControls col-xs-8">
								<div class="row clearfix" style="margin-top:0">
									...
									<div class="formControls col-xs-8">
								         <input style="width:206px;" type="text" class="input-text" placeholder="详细地址" name="address" id="address" >
							        </div>
							        </div>
								</div>
							</div>
